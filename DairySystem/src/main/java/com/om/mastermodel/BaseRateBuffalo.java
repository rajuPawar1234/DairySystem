...
public class BaseRateBuffalo {
	...
	public BaseRateBuffalo(int id, float fat, float milkrate, float snf, String dateofchange, String milkType, int flag,
			ShopDetailsModel shopDetailsModel) {
		super();
		this.id = id;
		this.fat = fat;
